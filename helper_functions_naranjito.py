...
def calculate_results(y_true, y_pred):
  ...
  model_results = {"accuracy": model_accuracy/100.0,
...
"""
This function was modified in some other exercises (I dont recall exactly all the changes I did...
So I left make_confusion_matrix (as old) and this one modified.
"""
import itertools

def make_confusion_matrix2(y_true, y_pred, classes=None, figsize=(10, 10), text_size=15, norm=False, savefig=False):
  """Makes a labelled confusion matrix comparing predictions and ground truth labels.
